...
export class CronDescriberU2Q {
     ...
     */
    static describeTime(hour, minute, options) {
        var _a;
        const use24 = (_a = options.use24HourTimeFormat) !== null && _a !== void 0 ? _a : false;
        ...
        if (this.isSimpleNumeric(hour) && (minute === "0" || minute === "*" || this.isSimpleNumeric(minute))) {
            ...
            if (m === null) {
                if (use24)
                    return `Every minute of hour ${hour.padStart(2, "0")}`;
